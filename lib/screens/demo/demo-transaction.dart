...
class DemoTransactionsType extends StatefulWidget {
  static const String routeName = "/demo-transaction";

  @override
  _DemoTransactionsTypeState createState() => new _DemoTransactionsTypeState();
}

class _DemoTransactionsTypeState extends State<DemoTransactionsType> {
  String routeName = DemoTransactionsType.routeName;
  AppBar commonAppBar;
