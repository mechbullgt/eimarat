...
import 'package:eimarat/screens/demo/demo-transaction.dart';
...
class DemoHome extends StatefulWidget {
  ...
  @override
  _DemoHomeState createState() => new _DemoHomeState();
}

class _DemoHomeState extends State<DemoHome> {
  String routeName = DemoHome.routeName;
  Widget previousPageWidget = DemoHome();
  Widget nextPageWidget = DemoTransactionsType();
  AppBar commonAppBar;
            ...
            new Row(
              ...
              children: <Widget>[
                RaisedButton(
                  ...
                  onPressed: () {
                    _navigatePage(previousPageWidget);
                  },
                  child: Text(
                    'Back',
